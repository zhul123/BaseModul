package com.base.http.okhttp.request;

import android.text.TextUtils;

import com.base.http.okhttp.OkHttpUtils;
import com.base.http.okhttp.utils.Exceptions;
...
public class OtherRequest extends OkHttpRequest
{
    ...
    {
        if (method.equals(com.base.http.okhttp.OkHttpUtils.METHOD.PUT))
        {
            builder.put(requestBody);
        } else if (method.equals(com.base.http.okhttp.OkHttpUtils.METHOD.DELETE))
        {
            if (requestBody == null)
                builder.delete();
            else
                builder.delete(requestBody);
        } else if (method.equals(com.base.http.okhttp.OkHttpUtils.METHOD.HEAD))
        {
            builder.head();
        } else if (method.equals(com.base.http.okhttp.OkHttpUtils.METHOD.PATCH))
        {
